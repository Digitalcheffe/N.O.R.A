...
func newIngestRouter(t *testing.T) (http.Handler, *repo.Store) {
	...
	store := repo.NewStore(appRepo, eventRepo, repo.NewCheckRepo(db), repo.NewRollupRepo(db), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestHandleIngest_HappyPath(t *testing.T) {
	...
	appRepo := repo.NewAppRepo(db)
	eventRepo := repo.NewEventRepo(db)
	s := repo.NewStore(appRepo, eventRepo, repo.NewCheckRepo(db), repo.NewRollupRepo(db), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	limiter := ingest.NewRateLimiter()
